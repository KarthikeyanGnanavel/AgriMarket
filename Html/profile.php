...
<body>
	...
	<!-- Slider Begins -->
	 ...
	 <div class="one-time">
	    <div><img src="assets/images/pic1.jpeg"></div>
	    <div><img src="assets/images/pic4.jpeg"></div>
	    <div><img src="assets/images/pic5.jpeg"></div>
  	</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div id="get_cat"></div>
				...
				<!--<div class="nav nav-pills nav-stacked">
					<li class="active"><a href="#"><h4>Variety</h4></a></li>
					<li><a href="#">Categories</a></li>
					<li><a href="#">Categories</a></li>
					<li><a href="#">Categories</a></li>
					<li><a href="#">Categories</a></li>
			...
			<div class="col-md-8">
				...
				<div class="panel panel-info">
					<div class="panel-heading text-center">--Featured Crops--
					...
					<div id="get_product"></div>
						<!--<div class="col-md-4">
							<div class="panel panel-info">
								<div class="panel-heading">Maize</div>
								<div class="panel-body"><img src="assets/prod_images/maize.jpg"></div>
								<div class="panel-heading">Rs500.00
								<button class="btn btn-danger btn-xs" style="float:right;">Add Crop</button>
								</div>
							</div>
						</div>-->
					</div>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        ...
				        <h4 class="modal-title" id="myModalLabel">Crop Details</h4>
				      </div>
